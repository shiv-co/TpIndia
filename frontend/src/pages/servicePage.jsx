    ...
    <div className="bg-[var(--bg-color)] text-[var(--text-primary)]">
      ...
      <section className="relative h-[60vh] md:h-[70vh] w-full overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto h-full flex flex-col items-center justify-center px-6 text-center">
          ...
          >
            We Design <span className="text-[var(--accent-color)]">Visual</span>{" "}
            Experiences
          </motion.h1>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold mb-6">
            ...
            <span className="text-[var(--accent-color)]"> Visual Reality</span>
          </h2>
        ...
        >
          ...
          <p>
            Our teams blend creative direction, on-ground execution, and digital
            performance to deliver stories that your audience remembers long
            after the screen fades to black.
          </p>
          <p>
            Whether you&apos;re a brand, startup, NGO, or artist — we adapt our
            visual language to your world, and then push it forward.
          </p>
        </motion.div>
      </section>
