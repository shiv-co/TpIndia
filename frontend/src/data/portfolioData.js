...
export const sectionDescriptions = {
  ...
  "Live Streaming & Broadcasting":
    "Multi-camera live production for launches, conferences, performances and cultural programming.",
  "Podcasts & Interviews":
    "Studio conversations and interview formats shaped for trust, retention and repeat viewing.",
  "Event Coverage & Photography":
    "Cinematic coverage for live moments, rituals, stages and audience energy.",
  "Music Videos":
    "Performance and narrative-led visuals with mood, rhythm and replay value.",
  "Ad/TVC Films":
    "Commercial films crafted for recall, clarity and conversion across campaign touchpoints.",
  "Reels/Shorts":
    "Fast vertical edits built for discovery, retention and social-first storytelling.",
  "Short Films":
    "Compact narrative films with cinematic pacing, emotional clarity and strong visual identity.",
};
